...
def main():
    ...
    mlpr
    '''
    mlpr = MLPRegressor(hidden_layer_sizes=1000,max_iter=10000)
    ...
    for i in range(len(dif)):
        ...
        print(a)
        a = a.round(6)
        mean_square = mean_square + a
        mean_square = mean_square.round(6)
        print(mean_square)
    print(mean_square)
    ...
    result_df.to_csv("neural_network_model22.csv")
